...
const PATHS: Record<IconName, string> = {
  ...
  // サイコロ（5の目：四隅＋中央）。1の目だと単なる点付きの箱に見えるため、
  // 一目でサイコロと分かる5の目にする。「ランダム」ボタン用
  dice: `<rect x="2.2" y="2.2" width="11.6" height="11.6" rx="2.2"/>
    <circle cx="5.3" cy="5.3" r="1" class="solid"/>
    <circle cx="10.7" cy="5.3" r="1" class="solid"/>
    <circle cx="8" cy="8" r="1" class="solid"/>
    <circle cx="5.3" cy="10.7" r="1" class="solid"/>
    <circle cx="10.7" cy="10.7" r="1" class="solid"/>`,
