...
const PATHS: Record<IconName, string> = {
  ...
  fill: `<path d="M6.6 2.6 2.9 6.3a1.6 1.6 0 0 0 0 2.3l3.2 3.2a1.6 1.6 0 0 0 2.3 0l3.7-3.7z"/>
    <path d="M13 9.6c.7 1 1 1.7 1 2.2a1.1 1.1 0 0 1-2.2 0c0-.5.4-1.2 1.1-2.2Z" class="solid"/>`,
